...
class CustomAccountManager(BaseUserManager):
    ...
    def create_superuser(self, email, broj_indeksa, ulogaFK, password, **other_fields):
        ...
        return self.create_user(email, broj_indeksa, ulogaFK, password, **other_fields)

    def create_user(self, email,broj_indeksa, ulogaFK, password, **other_fields):
        ...
        user = self.model(email=email, broj_indeksa=broj_indeksa, ulogaFK=ulogaFK, **other_fields)
...
class termini(models.Model):
    ...
    zavrsetak = models.TimeField(auto_now_add=True)
    zavrsetak = models.TimeField(auto_now_add=True)
    trajanje = models.TimeField(auto_now_add=True)
