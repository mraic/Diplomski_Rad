...
from diplomskirad import views
...
urlpatterns = [
    ...
    path('evidencija-detail/<int:pk>',
         views.evidencijaDetail, name='evidencijadetail'),
    path('evidencija-create/', views.evidencijaCreate, name='evidencijacreate'),
    path('evidencija-update/<int:pk>',
         views.evidencijaUpdate, name='evidencijaupdate'),
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(
        template_name='lozinka/password_reset.html'), name='password_reset'),
